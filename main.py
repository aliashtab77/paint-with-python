...
root = Tk()
root.title("Tkinter - paint app - stark team")
...
change_bg_color_btn = Button(root, text="Change Background Color", command=change_bg_color)
change_bg_color_btn.grid(row=1, column=2)

change_pen_color_btn = Button(root, text="Change Pen Color", command=change_pen_color)
